import { faArrowLeft, faCartShopping, faTrash, faHeart } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      ...
      { wishListArray?.length>0?
             ...
             {wishListArray?.map((item)=>(
                <Col sm={12} md={4} lg={3} className='mt-5 d-flex justify-content-center ' >
                ...
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-between">
                    <Button onClick={()=>dispatch(removeFromWishlist(item.id))} className='border ' variant="warning"><FontAwesomeIcon icon={faTrash}  /></Button>
                    <Button onClick={()=>(handleDispatch(item))} className='border ' variant="success"><FontAwesomeIcon icon={faCartShopping} /></Button>
                  </div>
                </Card.Body>
              </Card>
                </Col>
